...
const Header = () => {
    return (
      <div className={style.wrapper}> 
        ...
        <Image src={logo} height ={50} width = {50} />  {/*logo*/}
        <div className={style.logoText}>OpenWater</div> {/*heading*/}
        </div>
        </Link>
        ...
        <div className={style.headerItems}>
            <Link href='/collections/0x9C53FE9A1D77Ff7e06033261e8AB4CFB655E80Fe'>
